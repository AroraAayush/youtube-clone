...
function VideoDetail() {
  ...
  return (
    <div className='h-screen  w-screen flex flex-row mx-6 justify-start  '>
        ...
        <div className='w-3/4 p-2 border-2 border-white/20 flex flex-col  h-[88%] overflow-y-scroll scrollbar-none overflow-x-hidden'>
        ...
        <div className='w-full h-full'>
            ...
            {videoDetails && videoDetails.items && <div className=' mt-3 text-base font-normal leading-relaxed'>{videoDetails.items[0].snippet?.description.slice(0,100)} ...</div>}  
